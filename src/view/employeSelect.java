 ...
 * @author Ruhi ÇELİK
 */
public class employeSelect extends javax.swing.JFrame {

    Connection conn=null;
ResultSet rs=null;
PreparedStatement ps=null;
    public employeSelect() {
        initComponents();
        setAlwaysOnTop(true);
...
else if (javaConnect.frameid==2)
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(employeSelect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
